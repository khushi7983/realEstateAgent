...
def build_real_estate_reply(transcript, city=None):
    return "I'm sorry, we're experiencing a technical issue at the moment. Could you please repeat your question?"
